...
class API{
	...
	# En "magisk" get funktion som gör att det går att hämta alla våra variabler inom -
    # objektet fast att de är privata, men vi kan inte lägga in värden i dem utanför objektet
	function __get($k){
		return $this->$k;
	}
	...
	function __construct(){
		...
		# Get the first resources id if exists
		if(count($request) > 0)
