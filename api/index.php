...
# Vi skapar en sträng som består av ett _ samt namnet på den resurs vi efterfrågar, 
# exempelvis som vi anropar /?/user kommer vår sträng blir _user. 
# Detta gör vi för att skapa lite säkerhet så man inte kan anropa klasser/objekt -
# som vi inte vill ska kunna köras via vårt API
$class = "_".$API->resource;

# Vi inkluderar filen med klassen för den resurs som efterfrågats, 
# exempelvis user.resource.php och denna fil innehåller en class med _user
...
# De två parametrar vi skickar med är resursens id (ex. 15 i /?/user/15) och sen resten av URL:en som en array -
# (Ex. i /?/user/15/friends/all kommer arrayen innehålla [0] "friends" och [1] "all")
